...
const string strMessageMagic = "Ducatcoin Signed Message:\n";
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DucatcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DucatcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("DucatcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("ducatcoin-miner");
    ...
    try { loop {
        ...
        printf("Running DucatcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("DucatcoinMiner terminated\n");
        throw;
    }
}
